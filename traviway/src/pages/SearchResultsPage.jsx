...
const SearchResultsPage = () => {
  ...
  useEffect(() => {
    const fetchResults = async () => {
      ...
      try {
        ...
        setError(
          "Failed to fetch search results. Please make sure backend services and API Gateway are available."
        );
      } finally {
        setLoading(false);
      }
  ...
  // Helper to get correct place image (absolute/relative/placeholder)
